...
(2, ''SQL Guide'', 2, 30),
(3, ''Smartphone'', 1, 800);',
N'Cơ sở dữ liệu mẫu về shop bán hàng'),
...
-- Insert sample Problems với ThemeId
INSERT INTO Problem (ProblemCode, ProblemName, ProblemDescription, DatabaseSchemaId, CoderId, Published, ThemeId) VALUES
('P001', N'Tìm sản phẩm đắt nhất', N'Viết câu lệnh SQL để tìm sản phẩm có giá cao nhất trong bảng Products', 1, 1, 1, 1),  -- ThemeId = 1 (SELECT cơ bản)
('P002', N'Đếm số sách theo tác giả', N'Viết câu lệnh SQL để đếm số lượng sách của mỗi tác giả', 2, 1, 1, 3);  -- ThemeId = 3 (GROUP BY và HAVING)
